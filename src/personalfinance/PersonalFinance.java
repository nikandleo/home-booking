...
//        System.out.println(sd);
    ...
    private static void testModel() throws ModelException {
        ...
        Account ac2 = new Account("Карта сбер", c1, 0);
        Account ac3 = new Account("Депозит руб", c1, 100000);
        Account ac4 = new Account("Депозит дол", c2, 0);
    ...
    private static void init(){
        ...
        try {
            ...
            ge.registerFont(Font.createFont(Font.TRUETYPE_FONT, Settings.FONT_ROBOT_LIGHT));
