...
final public class Style {
    ...
    public static final int PADDING_DIALOG_BALANCE = 3;
    ...
    public static final Icon ICON_LEFT_PANEL_BALANCE_CURRENCIES = new ImageIcon("images/balance_currencies.png");
    public static final Icon ICON_LEFT_PANEL_BALANCE = new ImageIcon("images/balance.png");
    ...
    public static final ImageIcon ICON_PANEL_TRANSACTIONS = new ImageIcon("images/panel_transactions.png");
    ...
    public static final ImageIcon ICON_PANEL_STATISTICS = new ImageIcon("images/statistics.png");
