...
final public class Text {
    ...
    public static String get(String key)
    {
        ...
        System.out.println("Такого ключа в Text не существует: " + key);
        return "";
    }
    ...
    public static void init(){
        ...
        data.put("ERROR_NO_BASE_CURRENCY", "Необходима основная валюта! Установите данный параметр в другой валюте, затем он снимется в данной валюте автоматически.");
        ...
        data.put("CODE", "Код");
        data.put("RATE", "Курс");
        data.put("IS_ON", "Включено");
        data.put("IS_BASE", "Базовая");
