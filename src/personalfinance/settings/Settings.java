...
import personalfinance.PersonalFinance;
...
final public class Settings {
    public static final File FONT_ROBOT_LIGHT = new File("fonts/Roboto-Light.ttf");
    ...
    public static void init(){
        try {
            ...
            save();//Logger.getLogger(Settings.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
